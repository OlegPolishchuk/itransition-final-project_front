          ...
          root: {
            ...
            '& .MuiOutlinedInput-root': {
              '&.Mui-focused fieldset': {
                borderColor:
                  mode === 'dark' ? 'rgba(255,255,255,.6)' : colors.primary.second,
              },
            },
          },
        },
        ...
        styleOverrides: {
          root: {
            ...
            '&.MuiButton-outlined': {
              ...
              borderColor:
                mode === 'dark' ? colors.secondary.main : colors.secondary.main,
              '&:hover': {
                borderColor:
                  mode === 'dark' ? colors.secondary.second : colors.secondary.second,
              },
              ...
              '&.MuiButton-outlinedPrimary': {
                ...
                '&:hover': {
                  ...
                  borderColor:
                    mode === 'dark' ? 'rgba(255,255,255,.9)' : colors.primary.second,
                },
              },
            },
